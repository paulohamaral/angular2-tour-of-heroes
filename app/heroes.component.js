...
var HeroesComponent = (function () {
    ...
    HeroesComponent.prototype.getHeroes = function () {
        var _this = this;
        //this.heroService.getHeroesSlowly().then(heroes => this.heroes = heroes); //Slowly Promisse
        this.heroService.getHeroes().then(function (heroes) { return _this.heroes = heroes; }); //Fast Promisse
    };
